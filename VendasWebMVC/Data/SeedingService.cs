...
namespace VendasWebMVC.Data
{
    public class SeedingService
    {
        ...
        public SeedingService(BdContext bdContext)
        {
        ...
        public void Seed()
        {
            if (_bdContext.Department.Any() || _bdContext.Seller.Any() || _bdContext.SalesRecord.Any()) { return; }
            ...
            _bdContext.Department.AddRange(d1, d2, d3, d4);

            _bdContext.Seller.AddRange(s1, s2, s3, s4, s5, s6);

            _bdContext.SalesRecord.AddRange(
